...
def train(*args):
    ...
    instance_dir = os.path.join(
                        '/home/liucha90/scratch/1666project', 
                        config["DATA_DIR"], 
                        args.dataset_name, 
                        'INSTANCES'
                        )
    ...
    plot_dir = os.path.join('/home/liucha90/scratch/1666project', config['PLOT_DIR'], model_name)
    model_dir = os.path.join('/home/liucha90/scratch/1666project', config['MODEL_DIR'], model_name)
    result_dir = os.path.join('/home/liucha90/scratch/1666project', config['RESULT_DIR'], 'train')
