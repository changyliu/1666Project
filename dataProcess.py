...
# ------------------------------------------------------------------
# To obtain LKH tours, do the following process:
# 1. run txt_to_pfptw_all() to convert instance files (.txt) to pdptw files and save them in INSTANCES_LKH:
#     txt_to_pdptw_all(f'{dataset_name}')
# 2. Make a shell script that runs LKH to all the instance files made in step 1:
#     make_runAll_PDPTW_ours(f'{dataset_name}')
# 3. Copy the dataset folder to the LKH home folder
#    LKH-3.0.8
#      └-- f'{dataset_name}'
# 4. Copy the shell script ('runAll_PDPTW_ours') created in the dataset folder to the LKH home folder
#    LKH-3.0.8
#      ├-- f'{dataset_name}'
#      └-- runAll_PDPTW_ours
# 5. Set the dataset name in run_PDPTW in the LKH home folder
...
if __name__ == "__main__":
    ...
    #txt_to_pdptw_all('data/1PDPTW_generated_d31_i200_tmin300_tmax500_sd2022_test')
    #txt_to_pdptw_all('data/1PDPTW_generated_d51_i200_tmin300_tmax500_sd2022_test')
    #make_runAll_PDPTW_ours('data/1PDPTW_generated_d31_i200_tmin300_tmax500_sd2022_test', max_trials=10000, runs=3)
    get_results_LKH('data/1PDPTW_generated_d31_i200_tmin300_tmax500_sd2022_test')
